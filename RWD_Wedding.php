...
<div id="carouselExampleInterval" class="carousel slide" data-ride="carousel">
  ...
  <a class="carousel-control-next" href="#carouselExampleInterval" role="button" data-slide="next">
    ...
    <button type="" class="btn btn-lg prePage" onclick="location.href='<?= WEB_ROOT ?>/RWD_Wedding.php?sid=<?= $row['sid']-1?>'">前一個作品 </button>
    <button type="" class="btn btn-lg nextPage" onclick="location.href='<?= WEB_ROOT ?>/RWD_Wedding.php?sid=<?= $row['sid']+1?>'">下一個作品</button>
</span>
