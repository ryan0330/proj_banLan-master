...
<body>
                ...
                <div>
                    <ul class="cart-empty">
                        ...
                        <li class="clickMeBack">
                            <a href="<?= WEB_ROOT ?>/RWD_product.php">購物車內沒有商品!<br>
                                點我回商品頁!
                            </a>
                        </li>
                    </ul>
    ...
    <!-- 換總價 -->
        ...
        <div class="container2">
            <button type="" class="bttn left-button" onclick="location.href='<?= WEB_ROOT ?>/RWD_product.php'">
            <p>回商品頁</p>
            </button>
            <?php if (isset($_SESSION['member'])) : ?>
            <button type="" class="datail_next bttn right-button active1" role="button" onclick="location.href='<?= WEB_ROOT ?>/RWD_cart_3_course.php'">
                <p>下一步</p>
            </button>
            <?php else: ?>
                <button type="" class="bttn right-button active1 toMember" role="button" onclick="location.href='<?= WEB_ROOT ?>/RWD_mobile-1login.php'">
                請登入再結帳
                </button>  
            <?php endif;?>
        </div>
