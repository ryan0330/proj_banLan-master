...
<body>
    ...
    <label class="address" for="inputState" name="package">
            ...
            <div class="transport_bu_input ">
              <div class="form-check form-check-inline">
                  ...
                  <div class="delivery">
                  <p>宅配</p>
                  <input class="form-check-input tohome click_two shipWay" type="radio" name="addressC" id="inlineRadio1" value="宅配" checked>
                  </div>
                  <div class="delivery">
                  <p>到店取貨</p>  
          ...
          <div class="time_bu_input">
              <div class="time_bu_input_two">
                <select for="SendTime form-control setL">
                  ...
                  <option class="input_all SendTime" type="radio" name="SendTime" value="18-21點">18-21點</option>
    ...
    <div class="person">
      <div class="title-infor">
        ...
        <div class="atm payment_hide payment_show">
            ...
            <div class="form-group">
                <label for="exampleInputPassword1" class="bank account_code">請輸入帳號(末五碼)</label>
                <input type="number" class="form-control inputL" id="bankAcount" type="text" placeholder="76542">
        ...
        <div class="creditblank credit_hide credit_show"> 
            <div class="form-group">
                ...
                <input type="number" class="form-control" id="creditAcount" aria-describedby="emailHelp" placeholder=" 9384-3495-6984">
            </div>
  ...
  <div class="container">
   ...
   <div class="container2">
       ...
       <button type="" class="bttn left-button" onclick="location.href='<?= WEB_ROOT ?>/RWD_cart_2.php'">
          <p>上一步</p>
       </button>
       <button type="" class="bttn right-button active1 NextPage">
          <p>下一步</p>
       </button>
   </div>
