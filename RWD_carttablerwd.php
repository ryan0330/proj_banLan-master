...
if (empty($_SESSION['cart']) or empty($_SESSION['member']) or empty($_SESSION['receiver'])){
    header('Location: RWD_product.php');
    exit;
}
...
<div class="mewberlist d-flex">
    ...
    <?php endif; ?>
        ...
        <div class="mewall2">
            <div class="mewtext">
                ...
                <div class="mewtotal2 d-flex">
                    ...
                    <p class="infoText">共<span class="cart-count">0</span>件</p>
                </div>
         </div>
                    <!-- ------------------------------------------------------ -->
        ...
        <div class="bttn1 d-flex">
            <button class="bttn d-flex LastPage" type=""  onclick="location.href='<?= WEB_ROOT ?>/RWD_cart_3_course.php'">
            修改</button>
            <button class="bttn d-flex active NextPage buyBtn" type="" onclick="changePage()">
            確認</button>
