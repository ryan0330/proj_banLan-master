...
<body>
    ...
    <?php endif; ?>
        ...
        <div class="bttn1 d-flex">
            <button class="bttn d-flex" type="" onclick="location.href='<?= WEB_ROOT ?>/RWD_index.php'">回首頁</button>
            <button class="bttn d-flex active" type="" onclick="location.href='<?= WEB_ROOT ?>/RWD_mobile-1-2.php'">回會員</i></a>
        </div>
        <?php endif; ?>
