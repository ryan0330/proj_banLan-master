      ...
      <div class="QA">
        ...
        <div class="main">
            <table cellspacing="10" class="tableAll col-sm-10">
                <tr>
                <th rowspan="3" class="picture"><img src="img/small/sea-1.jpg" alt=""></th>    
                    <td>商品名稱</td>
                    <td>人海中遇見你</td>
                </tr>
                <tr>
            ...
            <div class="search col-6"><a class="name" href="">尚有貨</a></div>
            <div class="search1 col-6"><butoon class="name" type="" onclick="location.href='<?= WEB_ROOT ?>/RWD_mobile-2-2Order.php'">加入購物車</button></div>
            </div>
        </div>
