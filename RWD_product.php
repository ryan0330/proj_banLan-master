...
.boxBorder:hover:before, .boxBorder:hover:after {
  transform: skew(0, 0);
    ...
    #colorAll[type=radio] {
        background-image: linear-gradient(to right bottom, #ff0000, #ffa500, #ffff00, #008000,  #9400d3);
    }
    #colorW[type=radio] {
        ...
        <div class="col">
            <div id="carouselExampleControls" class="carousel slide" data-ride="carousel">
                <div class="carousel-item active">
                    <img src="img/products/banner1.jpg" class="d-block " alt="...">
                </div>
                <div class="carousel-item">
                    <img src="img/products/banner2.jpg" class="d-block " alt="...">
                </div>
                <div class="carousel-item">
                    <img src="img/products/banner3.jpg" class="d-block " alt="...">
                </div>
            </div>
        </div>
    </div>
        ...
        <div class="col main">
            ...
            <div class="barLeft col-lg-3">
                ...
                <div class="chose">
                    ...
                    <div class="">
                        <ul class="categoryChose">
                            ...
                            <li>
                                <label class="category"><input type="radio" name="cate" class="input_all" value="3" id="bouquet">花束</label>
                            </li>
                            <li>
                                <label class="category"><input type="radio" name="cate" class="input_all" value="2" id="giftFlower">禮盒花</label>
                            </li>
                            <li>
                                <label class="category"><input type="radio" name="cate" class="input_all" value="1" id="headFlower">捧花、頭花</label>
                            </li>
                            <li>
                ...
                <div class="color">
                    <h3>Color</h3>
                    <div>
                        <ul class="d-flex colorBox">
                            <li class="" >
                                <label class=" colorSelect ">
                                    <input type="radio" id="colorAll" name="colorChose" value="0" class="colorBtn" checked/>
                                    <span></span>
                                </label>
                            </li>
                            <li class="" >
                            ...
                            <li class="">
                                <label class="colorSelect ">
                                    <input type="radio" id="colorG" name="colorChose" value="7" class="colorBtn " />
                                    <span></span>
                                </label>
                            </li>
                        </ul>
...
const productTpl = function(obj){
    return `<div class="productItem " data-sid="${obj.sid}" >
            <div class="f-box boxBorder">
                <a href="RWD_product_in.php?sid=${obj.sid}">
...
function productHash(){
    let h = unescape(location.hash.slice(1));
    let sendObj = {};
    ...
    if(sendObj.cate && parseInt(sendObj.cate)>0){
        document.form1.cate.value = sendObj.cate;
    }
    if(sendObj.colorChose && parseInt(sendObj.colorChose)>0){
        document.form1.colorChose.value = sendObj.colorChose;
    }
    if(sendObj.style && parseInt(sendObj.style)>0){
        document.form1.style.value = sendObj.style;
    }


    $.get('product_api.php', sendObj, function(data){
