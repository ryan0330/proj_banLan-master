...
<div class="row">
        ...
        <table class="tableAll">
                ...
                <tr class="allProduct">
                    <td>
                        <div class="productItem d-flex">
                            <div class="pictureItem">
                                <img class="imgFix" src="img/small/sea-1.jpg" alt="">
                            </div>
                            <div class="textItem">
                                <p>人海中遇見你</p>
                            </div>
                    ...
                    <td>
                        <div class="productItem2 ">40x50x40cm</div>
                    </td>
                    <td>
                        <div class="productItem2 ">NT.3,580</div>
                    </td>
                    <td>
                ...
                <!-- <tr class="allProduct">
                    ...
                    <td>
                        <div class="productItem2 "> 28×28×26cm</div>
                    </td>
                    <td>
                        <div class="productItem2 ">NT.3,650</div>
                    </td>
                    <td>
                        <div class="productItem2 "><i class="fas fa-heart likeAdd active"></i></div>
                    </td>
